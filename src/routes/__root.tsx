...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Smart Pole – Intelligent Community Safety System" },
      { property: "og:description", content: "Advanced smart city control platform for intelligent community safety monitoring and management." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Smart Pole – Intelligent Community Safety System" },
      { name: "twitter:description", content: "Advanced smart city control platform for intelligent community safety monitoring and management." },
